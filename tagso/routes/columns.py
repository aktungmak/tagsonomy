...
def columns_get():
    ...
    for column in columns:
        column['assigned_properties'] = gm.get_assignments(column_uri=column['uri'])
    return render_template("columns.html", columns=columns, column_uri=column_uri, catalogs=catalogs,
                           user_ns=str(USER_NS))
